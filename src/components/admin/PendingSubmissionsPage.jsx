...
const PendingSubmissionsPage = () => {
    ...
    setTimeout(() => {
      const mockSubmissions = [
        ...
        },
        {
          ...
          description: 'Luxury SUV with Quattro all-wheel drive. Perfect for family trips. Well maintained with recent service.',
          images: [
          ...
          features: ['All-Wheel Drive', 'Panoramic Roof', 'Heated Seats', 'Navigation', 'Apple CarPlay'],
          owner: {
            id: 'OWN-002',
            name: 'Lisa Anderson',
        ...
        },
        {
          ...
          securityDeposit: 400,
          location: 'Miami, FL',
          description: 'Powerful V8 muscle car. Loaded with performance features. Immaculate condition inside and out.',
          images: [
            'https://images.unsplash.com/photo-1584345604476-8ec5e12e42dd?w=400',
            'https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=400'
          ],
          features: ['V8 Engine', 'Premium Audio', 'Leather Seats', 'Performance Package', 'Launch Control'],
          owner: {
            id: 'OWN-003',
            name: 'Tom Harris',
        ...
        },
        {
          ...
          securityDeposit: 500,
          location: 'Seattle, WA',
          description: 'Electric SUV with autopilot. Great range and supercharging included. Like new condition.',
          images: [
          ...
          features: ['Autopilot', 'Glass Roof', 'Electric', 'Premium Interior', 'Supercharging'],
          owner: {
            id: 'OWN-004',
            name: 'Sarah Johnson',
  ...
  const submitReview = async () => {
    ...
    setTimeout(() => {
      ...
      toast.success(
        `Car ${reviewAction === 'approve' ? 'approved' : 'rejected'} successfully!`, 
        { id: 'review' }
      );
      ...
      console.log(`Sending ${reviewAction} email to ${selectedSubmission.owner.email}`);
  ...
  const getPriorityBadge = (priority) => {
    const badges = {
      high: <Badge variant="pending">⚠️ High Priority</Badge>,
      medium: <Badge variant="review">📝 Medium Priority</Badge>,
      low: <Badge variant="completed">✓ Low Priority</Badge>
    };
      ...
      <div className="flex flex-wrap justify-between items-center gap-4">
        <div>
          ...
          <p className="text-[#52525B] mt-1">
            Review and manage car owner submissions
          </p>
        </div>
                          ...
                          <div>
                            ...
                            <div className="space-y-2 text-sm">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span>{submission.owner.totalCars} cars listed</span>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="mt-4 p-4 bg-[#F9F8F6] rounded-lg">
                          ...
                          <div className="grid grid-cols-2 gap-4 text-sm">
                            <div className="flex justify-between">
                              ...
                              <span className="font-medium">${submission.pricePerDay}</span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-[#52525B]">Weekly Rate:</span>
